...
SRC_NAMES = base debug v asm gfx gfxdemo rnd sin ls turtle fractals \
    ...
    vic irq joy mouse mmlirq bounce rasterbars mousedemo charset scroll keyb blit xform keybdemo scrolldemo sidmusic double fp split splitdemo scroll8 scroll8demo

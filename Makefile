...
SRC_NAMES = base debug v asm gfx gfxdemo rnd sin ls turtle fractals \
    ...
    vic irq joy mouse mmlirq bounce rasterbars mousedemo charset scroll keyb blit xform keybdemo scrolldemo sidmusic double fp split splitdemo scroll8 scroll8demo synonym
...
docs/index.html: manual/index.adoc manual/words.adoc manual/links.adoc manual/sid.adoc manual/asm.adoc \
	...
	manual/intro.adoc manual/exceptions.adoc manual/irq.adoc manual/easyflash.adoc manual/assets.adoc
	rm -rf docs

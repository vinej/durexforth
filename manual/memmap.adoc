...
latest - $9fff :: Dictionary. Grows downwards as needed. On the EasyFlash cartridge the dictionary stops at $9cff instead, and $9d00 - $9f27 holds the driver that serves `include` from flash.
